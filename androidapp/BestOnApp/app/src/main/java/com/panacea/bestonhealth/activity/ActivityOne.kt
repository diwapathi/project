...
class CheckoutAddressActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prgDialog = ProgressDialog(this@CheckoutAddressActivity)
        ...
        client.post(
            ...
            object : AsyncHttpResponseHandler() {
                override fun onStart() {
                    super.onStart()
                    this@CheckoutAddressActivity.prgDialog?.show()
                }
                override fun onSuccess(statusCode: Int, headers: Array<Header>, responseBody: ByteArray) {
                    // Log.e("success_noti", String(responseBody) + "")
                    // super.onSuccess(statusCode, headers, responseBody)
                    this@CheckoutAddressActivity.prgDialog?.dismiss()
                    ...
                    val jsonSuccess=jsonResponse.getBoolean("success")
                      if(jsonSuccess){
                          var intent = Intent(this@CheckoutAddressActivity, CheckoutPrescriptionActivity::class.java)
                          startActivity(intent)
                          this@CheckoutAddressActivity.overridePendingTransition(R.anim.enter, R.anim.exit)
                      }
